                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(provider.events[provider.events.length - 1 - i].toMap()['time']),
                                          Text(
                                              provider.events[provider.events.length - 1 - i].toMap()['type'],
                                              style: TextStyle(
                                          ...
                                          Text(
                                              provider.events[provider.events.length - 1 - i].toMap()['description'],
                                              style: TextStyle(
                                                fontSize: 16,
                                                color: Colors.black,
                                              ),
                                          ),
                                          if (provider.events[provider.events.length - 1 - i].toMap()['type'] == 'APGAR')
                                          Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text(
                                                provider.events[provider.events.length - 1 - i].toMap()['info1'],
                                                style: TextStyle(
                                                  fontSize: 16,
                                              ...
                                              Text(
                                                provider.events[provider.events.length - 1 - i].toMap()['info2'],
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  color: Colors.grey[800],
                                                ),
                                              ...
                                              Text(
                                                provider.events[provider.events.length - 1 - i].toMap()['info3'],
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  color: Colors.grey[800],
                                                ),
                                              ...
                                              Text(
                                                provider.events[provider.events.length - 1 - i].toMap()['info4'],
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  color: Colors.grey[800],
                                                ),
                                              ...
                                              Text(
                                                provider.events[provider.events.length - 1 - i].toMap()['info5'],
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  color: Colors.grey[800],
                                                ),
